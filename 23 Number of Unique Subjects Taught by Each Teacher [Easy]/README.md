## [SQL50] 23. Number of Unique Subjects Taught by Each Teacher
...
count of distinct subject using COUNT and DISINCT, for each group of teacher_id.

In this case, the column, `dept_id` is redundant.
